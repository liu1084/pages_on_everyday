...
ARCH_EXCLUDE="alpha arm armel hppa hurd-i386 ia64 m68k mipsel mips powerpc s390 sparc"
...
# First sync stage
rsync -rltvHSB8192 --timeout 3600 --stats --partial --times \
	--exclude Packages* --exclude Sources* \
	--exclude Release* --exclude ls-lR*  --exclude .~tmp~/ \
...
if [ "$result" = 0 ]; then
# Second sync stage
rsync -rltvHSB8192 --timeout 3600 --stats \
	--exclude project/trace/$HOSTNAME --max-delete=40000 --delay-updates --delete \
